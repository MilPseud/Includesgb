...
if(isset($_GET['delmsg']))
{
	...
	header('Location: index.php?p=chatbox');
}
?>
...
<div class="chatbox" id="cb">
		...
		while($msg = $allmsg->fetch())
		{
			...
			{
			?>
			<a href="index.php?p=chatbox&delmsg=<?=$msg['id']?>"><span style="font-weight: bold; color: red" onmouseout="this.style.color='red'" onmouseover="this.style.color='white'">[X]</span></a>
			<?php
			}
			?>
