							...
							else
							{
								...
								header('Location: index.php?p=members');
									...
									?>
										<tr>
											<td>
												<img src="pics/rank/Grade<?= $imgrank2?>.png" alt="" />
											</td>
											<td>
											<?php
											...
											<td>
												...
												{
												?>
												<span class="banni">BANNI</span>
												<?php
												}
												elseif($line2['desert'] == 1)
												{
												?>
												<span class="deserteur">DÉSERTEUR</span>
												<?php
												}
												elseif($line2['ban'] == 0)
												{
												...
												?>
												<br>
												<span class="cadre">(Dignitaire)</span>
												<?php
												}
												...
												?>
												<br>
												<span class="mjs">(Dignitaire)</span>
												<?php
												}
												?>
											</td>
											...
											{
												?>
												<img title="Race: <?= $line2['race']?>" src="pics/race/Race<?= $line2['race']?>.png" alt=""/>
												<?php
											}
											else
											{
												?>
												<img title="Race: <?= $line2['race']?>" src="pics/race/RaceInconnue.png" alt=""/>
												<?php
											}
											?>
											</td>
											<td>
												...
												{
													?>
													<img title="Sceau d'approbation des MJs apposé par <?=$persovalid2['username']?>, <?=$date2?>" src="pics/Accueil/seal.png">
													<?php
												}
												elseif($persoinfo2['bgvalid'] == 2)
												{
													?>
													<img title="Sceau de désapprobation des MJs apposé par <?=$persovalid2['username']?>, <?=$date2?>" src="pics/Accueil/seal3.png">
													<?php
												}
												elseif($persoinfo2['bgvalid'] == 0)
												{
													?>
													<img title="En cours d'examination !" src="pics/Accueil/seal2.png">
													<?php
												}
												?>
											</td>
											...
											<td>
												...
												{
													?>
													<a href="index.php?p=karma&perso=<?=$line2['id']?>" class="username-detail">
											...
											<td>
												...
												{
													?>
														<a href="index.php?p=avis&perso=<?=$line2['id']?>">
													<?php
												}
												elseif($total2 >= 1)
												{
											...
											$zero4 = $rowzero4->rowCount();
												...
												{
												?>
													<a class="username-detail" href="index.php?p=members&perso=<?=$line2['id']?>&plus3=1">[+1]</a>
												<?php
												}
												if($zero4 == 0)
												{
												?>
													<a class="username-detail" href="index.php?p=members&perso=<?=$line2['id']?>&zero3=1">[0]</a>
												<?php
												}
												if($moins4 == 0)
												{
												?>
													<a class="username-detail" href="index.php?p=members&perso=<?=$line2['id']?>&moins3=1">[-1]</a>
												<?php
												}
											}
											?>
							...
							else
							{
								...
								header('Location: index.php?p=members');
									...
									?>
										<tr>
											<td>
												<imgsrc="pics/rank/Grade<?= $imgrank3?>.png" alt=""/>
											</td>
											<td>
											<?php
											...
											{
												?>
												<img src="pics/MiniImage/user_<?= $line3['id']?>.png" alt=""/>
												<?php
											}
											?>
											</td>
											...
											<td>
												...
												{
													?>
													<img title="Sceau d'approbation des MJs apposé par <?=$persovalid3['username']?>, <?=$date3?>" src="pics/Accueil/seal.png">
													<?php
												}
												elseif($persoinfo3['bgvalid'] == 2)
												{
													?>
													<img title="Sceau de désapprobation des MJs apposé par <?=$persovalid3['username']?>, <?=$date3?>" src="pics/Accueil/seal3.png">
													<?php
												}
											...
											<td>
												...
												{
													?>
													<a href="index.php?p=karma&perso=<?=$line3['id']?>" class="username-detail">
