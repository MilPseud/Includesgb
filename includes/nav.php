	...
	switch ($_SESSION['rank'])
			{
				...
				case 1:  $color = "#00AA00"; $color = ($_SESSION['actif'] == 1)? "#FF5555" : $color;
				$color = ($_SESSION['digni'] == 3)? "#5555FF" : $color; break;
				case 2: $color = "#55FF55"; $color = ($_SESSION['actif'] == 1)? "#FF5555" : $color;
				$color = ($_SESSION['digni'] == 3)? "#5555FF" : $color; break;
				case 3: $color = "#FF55FF"; break;
				case 4: $color = "#00AAAA"; $color = ($_SESSION['pnj'] == 1)? "#AAAAAA" : $color;
				$color = ($_SESSION['pnj'] == 3)? "#55FFFF" : $color;
				$color = ($_SESSION['digni'] == 2)? "#FFFF55" : $color; break;
				case 5: $color = "#FFAA00"; $color = ($_SESSION['pnj'] == 2)? "#0200A6" : $color;
				$color = ($_SESSION['digni'] == 1)? "#AA00AA" : $color; break;
	...
	<ul>
		<li>
			<div class="link">
				...
				{
				?>
					<img valign="center" src="pics/MiniImage/user_<?= $_SESSION['id']?>.png" alt="" width="20px">
				<?php
				}
				?> <span style="color:<?= $color?>;<?= $styledieu?><?= $stylebasic?>font-weight: bold;font-size: 1.1em;"><?= $_SESSION['username']?> <?= $_SESSION['nom']?></span>
			</div>
		</li>
	</ul>
</div>
				...
				<li>
					<a href="index.php?p=support">
						<div class="link">
							...
							{
							?>
							<span style="color: red">[<?=$countspr2?>]</span>
							<?php
							}
							?>
						</div>
			...
			<a href="index.php?p=sondage">
				<div class="link">
					...
					if($countsondage > $countvote)
					{
						...
						?>
						<span style="color: red">[<?=$sondagevote?>]</span>
						<?php
					}
					?>
				</div>
				...
				<li>
					<a href="index.php?p=sucesskey">
						<div class="link">
							...
							{
							?>
							<span style="color: red">[<?=$countkey2?>]</span>
							<?php
							}
							?>
						</div>
			...
			<li>
				<a href="index.php?p=enca">
					<div class="link">
						...
						{
						?>
						<span style="color: red">[<?=$countenca2?>]</span>
						<?php
						}
						?>
					</div>
			...
			<li>
				<a href="index.php?p=candidmj&perso=0">
					<div class="link">
						...
						{
						?>
						<span style="color: red">[<?=$countcandid2?>]</span>
						<?php
						}
						?>
					</div>
			...
			<li>
				<a href="index.php?p=questlist">
					<div class="link">
						...
						{
						?>
						<span style="color: red">[<?=$countquestlist2?>]</span>
						<?php
						}
						?>
					</div>
		...
		<li>
			<a href="index.php?p=mp&mode=read">
				<div class="link">
					...
					{
					?>
					<span style="color: red">[<?=$countmp2?>]</span>
					<?php
					}
					?>
				</div>
		...
		<li>
			<div class="link">
				...
				<a href="http://rpnix.com/" target="_blank">
					<img style="border-radius: 10px" src="pics/Rpnix.png" width="15%" height="15%"> Rpnix.com
				</a>
				<br>
				<a href="http://runeterra.890m.com/" target="_blank">
					<img src="pics/rt.png" width="15%" height="15%"> Runeterra.com
				</a>
			</div>
		</li>
	</ul>
		...
		<li style="list-style-type: none;">
			<div class="link">
				<a href="index.php?p=convo">
					<img src="https://lh5.ggpht.com/1CxNUEdzrREikWZoaHIU5J63x2gOxTb7R-ZIbJd51uPBFt0jUj8AX2bMOhKiIBcuAqtH=w300" width="15%" alt=""> Skype
				</a>
			</div>
		</li>
		<li style="list-style-type: none;">
			<div class="link">
				<a href="https://discord.gg/BCPHean" target="_blank">
					<img src="https://lh3.googleusercontent.com/jgHA50UkErljsRAu97XzZYrRcg3eAE0qTHdpxqCWfcd2dn9x1eDkblhVoXVWfxTTJTsF=w300" width="15%" alt=""> Discord
				</a>
			</div>
		</li>
		<li style="list-style-type: none;">
			<div class="link">
				<a href="https://twitter.com/GaaranStrom" target="_blank">
					<img src="https://upload.wikimedia.org/wikipedia/fr/thumb/c/c8/Twitter_Bird.svg/1259px-Twitter_Bird.svg.png" width="15%" alt=""> Twitter
				</a>
			</div>
		</li>
		<li style="list-style-type: none;">
			<div class="link">
				<a href="http://steamcommunity.com/groups/Gaaranstrom" target="_blank">
					<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/1024px-Steam_icon_logo.svg.png" width="15%" alt=""> Steam
				</a>
			</div>
		</li>
		<li style="list-style-type: none;">
			<div class="link">
				<img src="http://vignette1.wikia.nocookie.net/leagueoflegends/images/1/12/League_of_Legends_Icon.png/revision/latest?cb=20150402234343" width="15%" alt=""> League of Legends
			</div>
		</li>
	</ul>
</div>
	...
	<ul>
		<li>
			<div class="link">
				...
				[<?= $degrad['symbol']?>] <a href="index.php?p=profile&perso=<?= $degrad['id']?>"><img width="20px" height="20px" src="pics/rank/Grade<?= $degrad['rank']?>.png"> <?= $degrad['username']?></a>
				<?php
				}
				?>
				</div>
		...
		<li>
			<div class="link">
				...
				<?php
					...
					?>
					<br>
					<a href="index.php?p=profile&perso=<?= $line['id']?>" title="<?= $line['pseudo']?>"><img valign="center" src="pics/rank/Grade<?= $imgrank?>.png" alt="" width="20px" /> <?= $line['username']?></a><?php if($line['vanish'] == 1) { ?> [V]<?php } ?>
					<?php
					}
				?>
				</ul>
